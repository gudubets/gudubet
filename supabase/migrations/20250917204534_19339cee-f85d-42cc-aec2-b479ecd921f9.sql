...
-- Unique constraint ekle (category + name kombinasyonu unique olsun)
ALTER TABLE public.site_images ADD CONSTRAINT site_images_category_name_unique UNIQUE (category, name);
