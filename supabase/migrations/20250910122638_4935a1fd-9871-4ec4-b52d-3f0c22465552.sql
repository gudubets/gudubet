-- Insert default KYC limits with proper casting
...
SELECT * FROM (VALUES
  ('level_0'::kyc_level, 0, 0, 0, 1000, 5000, 1000, ARRAY[]::kyc_document_type[]),
  ('level_1'::kyc_level, 500, 5000, 25000, 5000, 25000, 10000, ARRAY['identity_card']::kyc_document_type[]),
  ('level_2'::kyc_level, 2000, 25000, 100000, 25000, 100000, 50000, ARRAY['identity_card', 'address_proof']::kyc_document_type[]),
  ('level_3'::kyc_level, 10000, 100000, 500000, 100000, 500000, 250000, ARRAY['identity_card', 'address_proof', 'selfie_with_id']::kyc_document_type[])
...
-- Create function to validate withdrawal against KYC
