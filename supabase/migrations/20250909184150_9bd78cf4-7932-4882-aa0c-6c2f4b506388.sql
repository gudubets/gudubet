-- Create comprehensive fraud detection system (Phase 3)

-- Add new columns to fraud_rules table
...
-- Update existing rules to have proper values
...
-- IP Analysis table for VPN/Proxy detection
...
-- Device fingerprinting for device analysis
...
-- User risk profiles for comprehensive risk management
