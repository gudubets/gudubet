...
-- First, we need to create the user in the admins table
...
BEGIN
    ...
    LOOP
        ...
        VALUES (admin_record.id, permission_name, true)
        ON CONFLICT (admin_id, permission_name) DO UPDATE SET is_granted = true;
    END LOOP;
END $$;